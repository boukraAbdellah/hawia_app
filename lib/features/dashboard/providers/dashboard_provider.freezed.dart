...
abstract class $DashboardStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({DashboardStats? stats, bool isLoading, String? error});
...
class _$DashboardStateImpl implements _DashboardState {
  const _$DashboardStateImpl({this.stats, this.isLoading = false, this.error});
  ...
  @override
  String toString() {
    return 'DashboardState(stats: $stats, isLoading: $isLoading, error: $error)';
  }
